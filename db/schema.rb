...
ActiveRecord::Schema.define(version: 20200306180432) do
  ...
  create_table "customers", force: :cascade do |t|
    ...
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
    t.index ["package_id"], name: "index_customers_on_package_id", using: :btree
  end
  ...
  add_foreign_key "customers", "packages"
